...
import { Box, Button, Table, TableCell, TableContainer, TableHead, TableRow, Typography,Paper,TableBody, Container, FormControl, FormLabel, RadioGroup, FormControlLabel, Radio} from "@mui/material";
...
const Checkout = () => {
  ...
  return (
    ...
    <TableContainer className="shadow-lg bg-gray-100">
      <Table sx={{ minwidth:"40%" }}>
        ...
        <TableBody>
          ...
          <Box sx={{marginTop:"50px"}}>
            <Typography variant="h3" fontSize="22px">Selectionnez le mode de paiement:</Typography>
      ...
      >
        <FormControlLabel value="livraison" control={<Radio />} label="Paiement a la livraison" onClick={()=>setChoice("livraison")} defaultChecked={true}/>
        <FormControlLabel value="credit" control={<Radio />} label="Payez avec votre carte de débit" 
        ...
        />
          ...
          <Button variant="contained" size="large" onClick={makePayment}>PASSER LA COMMANDE</Button>
          </Box>
        </Box>
