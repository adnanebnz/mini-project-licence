  ...
  return (
    <Container sx={{ marginTop: "90px",marginBottom:"50px" }}>
      <Container>
        <div className="flex gap-9">
          ...
          <div className='flex flex-col gap-2'>
            ...
            <Box display ="flex" flexDirection="column" gap="20px" marginTop="20px">
              <Box display="flex" alignItems="center" justifyContent="start" gap="0.5rem">
                <Typography sx={{fontWeight:"600"}}>Combien de personnes vous etes?</Typography>
                <Box border="solid" borderRadius="5px" display="flex" alignItems="center"
                sx={{borderWidth:"1px"}}>
        ...
        <Box><Typography variant='h3' fontSize="26px">Localisation :</Typography></Box>
